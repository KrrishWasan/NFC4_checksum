...
export default function LoginPage() {
  ...
  const handleWalletConnect = async (walletName) => {
    ...
    try {
      // 1️⃣ Only MetaMask supported now
      ...
      // 7️⃣ If success, log in using AuthContext and redirect
      if (result.success) {
